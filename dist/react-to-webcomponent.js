...
/*react-to-webcomponent@1.6.0#react-to-webcomponent*/
define('react-to-webcomponent', ['exports'], function (exports) {
    ...
    exports.default = function (ReactComponent, React, ReactDOM) {
        ...
        targetPrototype[renderSymbol] = function () {
            if (this[shouldRenderSymbol] === true) {
                ...
                var element = React.createElement(ReactComponent, data);
                if (typeof ReactDOM.createRoot === 'function') {
                    if (!this[rootSymbol]) {
        ...
        if (ReactComponent.propTypes) {
            WebComponent.observedAttributes = options.dashStyleAttributes ? Object.keys(ReactComponent.propTypes).map(function (key) {
    ...
    function toDashedStyle() {
        var camelCase = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
        return camelCase.replace(/([a-z])([A-Z])/g, '$1-$2').toLowerCase();
    }
    function toCamelCaseStyle() {
        var dashedStyle = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
