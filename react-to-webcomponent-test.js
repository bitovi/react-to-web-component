...
QUnit.test("works with attributes values as objects", function (assert) {
  class Person extends React.Component {
    render() {
      return <h1>Hello, {this.props.person.first} {this.props.person.last}</h1>;
    }
  }
  ...
  var MyPerson = reactToWebComponent(Person, React, ReactDOM)
  ...
  fixture.appendChild(myPerson);

  fixture.innerHTML = "<my-person></my-person>";

  fixture.firstElementChild.setAttribute("person", { first: "Ivo", last: "Pinheiro" });

  assert.equal(fixture.firstElementChild.innerHTML, "<h1>Hello, Ivo Pinheiro</h1>");
